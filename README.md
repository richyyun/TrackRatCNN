...
I am currently using transfer learning with a pretrained network (ResNet-50) and re-formatting the fully connected layer into two parallel layers with a softmax output each for the x- and y-coordinates for the position of the rat's nose. 
